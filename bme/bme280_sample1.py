...
def bmeRead(i2c_address):
    setup(i2c_address)
    get_calib_param(i2c_address)

    if __name__ == '__main__':
        try:
            readData(i2c_address)
        except KeyboardInterrupt:
            pass


def writeReg(i2c_address, reg_address, data):
    bus.write_byte_data(i2c_address,reg_address,data)

def get_calib_param(i2c_address):
    calib = []
