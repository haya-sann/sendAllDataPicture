...
def capture_send():
    ...
    logger.info("brightness:"+str(picamera.brightness)+" ,contrast:"+(picamera.contrast))
...
if __name__ == '__main__':
    try:
        ...
        logger.info('電源モジュールに送信するコマンド用意：' + powerControlCommand + ':' + str(timeToOff) + '秒後に電源オフ、' + str(x*5) + '分後に起動')
