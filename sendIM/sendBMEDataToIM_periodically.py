...
#    fileObject = open(dir_path + '/mochimugi.log', 'r')#サーバーにログを送信する準備
    ...
    params_IM = urllib.urlencode({'c': str(imKey), 'date': str(d), 'pressure':10.0290911903,'outer_pressure':808.463170021,'humid':41.0034365578,'outer_humid':48.618686964,'temp':27.2804967258,'lux':26.6416666667,'cpu_temp':48.312,'outer_temp':26.8605769953})
